 ...
 */
export function CreateImageIcon({ className }: IconProps) {
  return (
...
export function PackagingDesignIcon({ className }: IconProps) {
  return (
    <svg className={cn("w-6 h-6", className)} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export function LogoDesignIcon({ className }: IconProps) {
  return (
    <svg className={cn("w-6 h-6", className)} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export function EditImageIcon({ className }: IconProps) {
  return (
    <svg className={cn("w-6 h-6", className)} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export function AiPhotoshootIcon({ className }: IconProps) {
  return (
    <svg className={cn("w-6 h-6", className)} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export function BrandMoodboardIcon({ className }: IconProps) {
  return (
    <svg className={cn("w-6 h-6", className)} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export function SocialAdsIcon({ className }: IconProps) {
  return (
    <svg className={cn("w-6 h-6", className)} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export function ProductMockupsIcon({ className }: IconProps) {
  return (
    <svg className={cn("w-6 h-6", className)} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
...
export function CardsPostersIcon({ className }: IconProps) {
  return (
    <svg className={cn("w-6 h-6", className)} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export function ImageIconSmall({ className }: IconProps) {
  return (
